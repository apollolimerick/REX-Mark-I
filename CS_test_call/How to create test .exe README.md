...
Because the command was run from inside the `REX\CS_test_call` directory, the compiler instantly drops a brand new, fully functional `Test_Valuation.exe` directly into that exact same folder.
